...
<?
	if(isset($_POST['EmailReg']) ){
		if(isset($_POST['ImieReg']) && isset($_POST['NazwiskoReg']) && isset($_POST['EmailReg']) && isset($_POST['HasloReg']) && isset($_POST['Radio'])){
			echo "Rejestrujesz siê danymi:<br>";
			...
			$kwerenda_dodania .= ")";
			echo "Kwerenda dodania u¿ytkownika: " . $kwerenda_dodania . "<br><br>";
			
			// Dodanie u¿ytkownika do bazy danych wed³ug kwerendy
			...
			echo "B³±d rejestracji - wprowad¼ raz jeszcze dane";
		}
	}
?>	
<?
