...
if(isLoggedPatient($hasloSql, $_SESSION['login'], $_SESSION['haslo'])){
    if(isset($_POST['uprawnienia']) || isset($_POST['id_nazwiska']) || isset($_POST['nazwisko']) || isset($_POST['imie']) || isset($_POST['email']) || isset($_POST['specjalizacja'])) {
    ...
    echo "Mo¿esz edytowaæ dane swojego konta - takie jak:<br><b>imiê</b>, <b>nazwisko</b>, <b>email</b> oraz je¿eli jeste¶ lekarzem swoj± <b>specjalizacjê</b><br><br>";
